...
for(k in 1:160)
{
  ...
  past<-read.csv("./LULC/LULC2018_3.csv") ##read in land cover percentage data
  future<-read.csv(paste0("./LULC/",trf[k,1],"_",2000+trf[k,2],"_mosaic_m.csv"))  ##for mean urban projection
